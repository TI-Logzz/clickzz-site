...
| — | `screens/QuizPlayerScreen.tsx`, `screens/PagePreviewScreen.tsx` | autoral | projetos publicados. A página "Sérum Vitamina C" (marca fictícia Lumen Skin) é uma página de vendas completa de produto físico (aviso de frete e pagamento na entrega, hero com prova social e ilustração, números, ativos, rotina de uso, avaliações, oferta de kit com preço, brindes, garantia, FAQ, CTA) que representa o resultado que o builder deve alcançar. |
